window.onload = function onLoad() {
  ...
  var raindt = database.ref('HCM/RAIN');
  ...
  var noisedt = database.ref('HCM/NOISE');
  ...
  var aqidt = database.ref('HCM/AQI');
  ...
  var tempdt = database.ref('HCM/TEMP');
  ...
  var humidt = database.ref('HCM/HUMI');
