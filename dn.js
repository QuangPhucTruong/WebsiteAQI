window.onload = function onLoad() {
    ...
    var raindt = database.ref('DN/RAIN');
    ...
    var noisedt = database.ref('DN/NOISE');
    ...
    var tempdt = database.ref('DN/TEMP');
    ...
    var humidt = database.ref('DN/HUMI');
